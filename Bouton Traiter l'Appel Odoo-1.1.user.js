...
(function() {
    ...
    function ajouterTexteCligonotant() {
        ...
        // Ajouter au début de la zone de réponse sans supprimer le contenu existant
        if (reponseField.firstChild) {
            reponseField.insertBefore(container, reponseField.firstChild);
            // Ajouter un saut de ligne après le conteneur
            const br = document.createElement('br');
            reponseField.insertBefore(br, container.nextSibling);
        } else {
            reponseField.appendChild(container);
            // Ajouter un saut de ligne après le conteneur
            reponseField.appendChild(document.createElement('br'));
        }
    }
